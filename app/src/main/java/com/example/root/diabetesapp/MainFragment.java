...
/**
 * Created by gemox94 on 24/11/16.
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(findViewById(R.id.fragment_container) != null){
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.fragment_container, welcomeActivity).commit();
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_grafic:
                ...
                transaction1.replace(R.id.fragment_container,grafic);
                transaction1.addToBackStack(null);
                transaction1.commit();
                break;
            case R.id.nav_grafic1:
                Grafic1 grafic1 = new Grafic1();
                FragmentTransaction transaction2 = getSupportFragmentManager().beginTransaction();
                transaction2.replace(R.id.fragment_container,grafic1);
